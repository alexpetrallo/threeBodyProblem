...
x_1 = np.array(np.linspace(-2, 2, 1000))
#x_1 = np.array(np.linspace(0, 1, 60))
y_1 = np.array(np.linspace(-2, 2, 1000))
z_1 = np.array(np.linspace(-2, 2, 1000))

phi1=phi1(x_1)
#ph1=phi1(x_3d, y_3d, z_3d)
#force1=force(phi1)
size=np.linspace(-2, 2, 1000)
...
ax.set_title('Dimensionless Potential in 2-D')
...
#fig = plt.figure()
plt.streamplot(x_1, y_1, force2_x, force2_y)
...
Y0 = np.array([0.16666666666666666, 0.8660254037844386 , 0, 0])
